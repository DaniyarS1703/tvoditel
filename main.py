...
@app.route('/style.css')  def style():       return send_from_directory('.', 'style.css')
@app.route('/order')   def order_page():   return send_from_directory('.', 'order.html')
@app.route('/list')    def list_page():    return send_from_directory('.', 'list.html')
@app.route('/client')  def client_page():  return send_from_directory('.', 'client.html')
@app.route('/driver')  def driver_page():  return send_from_directory('.', 'driver.html')
...
def start(message):
    ...
    bot.send_message(message.chat.id,
      "Добро пожаловать! Нажмите кнопку для открытия приложения:", reply_markup=kb)
